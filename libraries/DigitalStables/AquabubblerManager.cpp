...
void AquabubblerManager::begin(uint8_t numberOfWaterPoints, bool distr) {
...
void AquabubblerManager::updateValues(){
	...
	if(Meter10 != nullptr)updateMeter(*Meter10, meter10InEvent, aFlowMeter10EventData, currentSampleIndexMeter10, false);

}

void AquabubblerManager::updateMeter(FlowMeter & meter, bool & meterInEvent, FlowMeterEventData & aFlowMeterEventData, uint8_t & currentSampleIndexMeter, bool dist){
...
static void AquabubblerManager::sensor_10(){
	...
	if(Meter10 != nullptr)Meter10->count();
}
